...
var status = 0 #define se o personagem está parado ou jogando
var vscore = 1 #responsável por zerar os pontos
var x = 10 #velocidade do background e das coluna, e consequentemente do jogo
var y = 1.5 #velocidade do personagem na vertical
